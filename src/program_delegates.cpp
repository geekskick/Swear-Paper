...
void verbose_program_delegate::info(const std::string &msg) { std::cout << ansi_codes::yellow << "[INFO]\t" << ansi_codes::reset << msg << std::endl; }

void verbose_program_delegate::error(const std::string &msg) { std::cerr << ansi_codes::red << "[ERROR]\t" << ansi_codes::reset << msg << std::endl; }

void verbose_program_delegate::success(const std::string &msg) { std::cout << ansi_codes::green << "[SUCCESS]\t" << ansi_codes::reset << msg << std::endl; }
